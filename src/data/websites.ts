...
export const websites: Project[] = [
  {
    ...
    name: "Kubo Travels",
    description:
      "Travel agency website, Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.",
